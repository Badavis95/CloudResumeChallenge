...
<head>
    ...
    function updateVisitorCount() {
      fetch(apiEndpointUrl)
        ...
        .then(data => {
          visitorCount = parseInt(data.visitorCount);
          displayVisitorCount();
        })
...
<body>
  <h1>Visitor Count</h1>
  <p>Total number of visitors: <span id="visitor-count">0</span></p>
  </body>
</html>
...
<body>
    <div id="page-wrap">
        <div id="contact-info" class="vcard">
            ...
            <p> Cell: <span class="tel">646-784-1235</span>
                <br /> Email: <a class="email" href="mailto:badavis95@hotmail.com">badavis95@hotmail.com</a>
